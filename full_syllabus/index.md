...
| 2/28|Assumptions of modeling and model selection<br><br>Learning Objectives:<br><br>After this lecture, you should be able to:<br>* Describe how to examine residuals to assess model fit<br>* Describe the concept of crossvalidation and how it can be used to determine model complexity<br><br>|Adventure, Chapter 12 (section 12.1-12.2.2)<br>Watch Udacity video on cross-validation: https://www.youtube.com/watch?v=sFO2ff-gTh0|
